            ...
            <div class="slider-single-item">
                ...
                <div class="movie-item">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="mv-img-2">
                                <a href="#"><img src="{{asset('img/uploads/poster1.jpg')}}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="slick-multiItem2">
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('img/uploads/mv-it1.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                    ...
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('img/uploads/mv-it2.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                                <a  href="moviesingle.html"> Read more <i class="ion-android-arrow-dropright"></i> </a>
                                            </div>
                                    ...
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('img/uploads/mv-it3.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                                <a  href="moviesingle.html"> Read more <i class="ion-android-arrow-dropright"></i> </a>
                                            </div>
                                    ...
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('img/uploads/mv-it4.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                                <a  href="moviesingle.html"> Read more <i class="ion-android-arrow-dropright"></i> </a>
                                            </div>
                                    ...
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('img/uploads/mv-it5.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                                <a  href="moviesingle.html"> Read more <i class="ion-android-arrow-dropright"></i> </a>
                                            </div>
                                    ...
                                    <div class="slide-it">
                                        <div class="movie-item">
                                            <div class="mv-img">
                                                <img src="{{asset('img/uploads/mv-it6.jpg')}}" alt="">
                                            </div>
                                            <div class="hvr-inner">
                                                <a  href="moviesingle.html"> Read more <i class="ion-android-arrow-dropright"></i> </a>
                                            </div>
