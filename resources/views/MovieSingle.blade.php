                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mv-user-review-item">
                                            <div class="user-infor">
                                                <img src="{{asset('img/uploads/userava1.jpg')}}" alt="">
                                                <div>
                                                    <h3>Best Marvel movie in my opinion</h3>
                                                    <div class="no-star">
                                                        <i class="ion-android-star"></i>
                                        ...
                                        <div class="mv-user-review-item">
                                            <div class="user-infor">
                                                <img src="{{asset('img/uploads/userava2.jpg')}}" alt="">
                                                <div>
                                        ...
                                        <div class="mv-user-review-item">
                                            <div class="user-infor">
                                                <img src="{{asset('img/uploads/userava3.jpg')}}img/uploads/userava3.jpg" alt="">
                                                <div>
